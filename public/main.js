...
const dirPath = path.join(__dirname, "../posts/src");
  ...
  fs.readdir(dirPath, (err, files) => {
    ...
    files.forEach((file, i) => {
      ...
      fs.readFile(`${dirPath}/${file}`, "utf8", (err, contents) => {
        ...
        const summary = parseMetadata({ metadataIndices });
        ...
        post = {
          ...
          summary: summary ? summary : "No summary given",
        ...
        if (ilist.length === files.length) {
          ...
          fs.writeFileSync("src/allPosts.json", data);
        }
      });
    });
  });
